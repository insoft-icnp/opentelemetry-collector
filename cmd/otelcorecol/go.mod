...
require (
	...
	github.com/SigNoz/signoz-otel-collector v0.111.14 // indirect
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/healthcheckv2extension v0.115.0 // indirect
